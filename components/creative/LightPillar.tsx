...
const LightPillar = ({
    topColor = '#5227FF',
    middleColor = '#5227FF', // Default to top color if not provided
    bottomColor = '#FF9FFC',
    intensity = 1.0,
    rotationSpeed = 0.3,
    interactive = false,
    ...
    `;
      ...
      void main() {
        ...
        for(float i = 0.0; i < 100.0; i++) {
          ...
          // Tri-Color Gradient Logic
          float t = smoothstep(15.0, -15.0, pos.y);
          vec3 gradient = mix(uBottomColor, uMiddleColor, t * 2.0);
          if (t > 0.5) {
            gradient = mix(uMiddleColor, uTopColor, (t - 0.5) * 2.0);
          }
    ...
    }, [topColor, middleColor, bottomColor, intensity, rotationSpeed, interactive, glowAmount, pillarWidth, pillarHeight, noiseIntensity, pillarRotation, webGLSupported]);
